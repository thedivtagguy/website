...
function x(s) {
  ...
  return {
    c() {
      (t = h("header")), (c = h("div")), (d = h("a")), this.h();
    },
    l(s) {
      t = n(s, "HEADER", {});
      var h = a(t);
    ...
    h() {
      v(d, "href", "https://pudding.cool"),
        v(d, "class", "svelte-1x606o6"),
        v(c, "class", "wordmark svelte-1x606o6");
    },
    m(s, h) {
      e(s, t, h),
        r(t, c),
...
function w(s) {
  ...
  return {
    c() {
      (t = h("main")), p(c.$$.fragment), (o = i()), L && L.c(), this.h();
    },
    l(s) {
      t = n(s, "MAIN", { id: !0 });
      var h = a(t);
      u(c.$$.fragment, h), (o = M(h)), L && L.l(h), h.forEach(l), this.h();
    },
    h() {
      v(t, "id", "content");
    },
    m(s, h) {
      e(s, t, h), f(c, t, null), r(t, o), L && L.m(t, null), (x = !0);
    },
    p(s, [t]) {
      L && L.p && 1 & t && $(L, w, s, s[0], t, null, null);
    },
    i(s) {
      x || (z(c.$$.fragment, s), z(L, s), (x = !0));
    },
    o(s) {
      m(c.$$.fragment, s), m(L, s), (x = !1);
    },
    d(s) {
      s && l(t), V(c), L && L.d(s);
    }
...
function L(s, t, c) {
  let { $$slots: h = {}, $$scope: n } = t;
  return (
    (s.$$set = (s) => {
      "$$scope" in s && c(0, (n = s.$$scope));
    }),
    [n, h]
  );
}
