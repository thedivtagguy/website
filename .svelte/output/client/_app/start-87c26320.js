...
function U(t) {
  ...
  var a = t[0][1];
  function n(t) {
    let e = { $$slots: { default: [I] }, $$scope: { ctx: t } };
  ...
  return (
    a && (e = new a(n(t))),
    {
      ...
      l(t) {
        e && v(e.$$.fragment, t), (r = b());
      },
      m(t, o) {
        e && x(e, t, o), f(t, r, o), (s = !0);
      },
      p(t, s) {
        const i = 4 & s ? E(o, [q(t[2] || {})]) : {};
        if ((521 & s && (i.$$scope = { dirty: s, ctx: t }), a !== (a = t[0][1]))) {
          ...
          a
            ? ((e = new a(n(t))), _(e.$$.fragment), k(e.$$.fragment, 1), x(e, r.parentNode, r))
            : (e = null);
        } else a && e.$set(i);
      },
      i(t) {
        s || (e && k(e.$$.fragment, t), (s = !0));
      },
      o(t) {
    ...
    a && (e = new a(n())),
    {
      ...
      p(t, s) {
        ...
        if (a !== (a = t[0][2])) {
          ...
          a
            ? ((e = new a(n())), _(e.$$.fragment), k(e.$$.fragment, 1), x(e, r.parentNode, r))
            : (e = null);
        } else a && e.$set(i);
      },
      i(t) {
  ...
  return {
    ...
    p(t, r) {
      t[0][2]
        ? s
          ? (s.p(t, r), 1 & r && k(s, 1))
          : ((s = C(t)), s.c(), k(s, 1), s.m(e.parentNode, e))
        : s &&
          (j(),
          S(s, 1, 1, () => {
            s = null;
  ...
  return {
    ...
    p(t, r) {
      t[0][1]
        ? s
          ? (s.p(t, r), 1 & r && k(s, 1))
          : ((s = U(t)), s.c(), k(s, 1), s.m(e.parentNode, e))
        : s &&
          (j(),
          S(s, 1, 1, () => {
            s = null;
  ...
  return {
    ...
    h() {
      p(e, "id", "svelte-announcer"),
        ...
        p(e, "class", "svelte-9z6sc");
    },
    m(t, s) {
      f(t, e, s), r && r.m(e, null);
    },
    p(t, s) {
      t[5] ? (r ? r.p(t, s) : ((r = B(t)), r.c(), r.m(e, null))) : r && (r.d(1), (r = null));
    },
    d(t) {
      t && d(e), r && r.d();
    }
...
function B(t) {
  ...
  return {
    c() {
      (e = g("Navigated to ")), (r = g(t[6]));
    },
    l(s) {
      (e = m(s, "Navigated to ")), (r = m(s, t[6]));
    },
    m(t, s) {
      f(t, e, s), f(t, r, s);
    },
...
function K(t) {
  ...
  return {
    c() {
      e && _(e.$$.fragment), (r = $()), l && l.c(), (s = b());
    },
    l(t) {
      e && v(e.$$.fragment, t), (r = w(t)), l && l.l(t), (s = b());
    },
    m(t, a) {
      e && x(e, t, a), f(t, r, a), l && l.m(t, a), f(t, s, a), (o = !0);
    },
    p(t, [o]) {
      const c = 2 & o ? E(a, [q(t[1] || {})]) : {};
      if ((525 & o && (c.$$scope = { dirty: o, ctx: t }), n !== (n = t[0][0]))) {
        if (e) {
          j();
          const t = e;
          S(t.$$.fragment, 1, 0, () => {
        ...
        n
          ? ((e = new n(i(t))), _(e.$$.fragment), k(e.$$.fragment, 1), x(e, r.parentNode, r))
          : (e = null);
      } else n && e.$set(c);
      t[4]
        ? l
          ? l.p(t, o)
          : ((l = D(t)), l.c(), l.m(s.parentNode, s))
        : l && (l.d(1), (l = null));
    },
    i(t) {
    ...
    o(t) {
      e && S(e.$$.fragment, t), (o = !1);
    },
    d(t) {
      e && L(e, t), t && d(r), l && l.d(t), t && d(s);
    }
  };
}
function W(t, e, r) {
  let { stores: s } = e,
    ...
    { props_1: i = null } = e,
    { props_2: l = null } = e;
  O("__svelte__", s), N(s.page.notify);
  let c = !1,
    u = !1,
    h = null;
  return (
...
const Y = {},
  G = function (t, e) {
    ...
    if (void 0 === M) {
      ...
      M = t && t.supports && t.supports("modulepreload") ? "modulepreload" : "preload";
    }
    return Promise.all(
      e.map((t) => {
        if (t in Y) return;
  ...
  J = [
    () =>
      G(
        () => import("./pages/$layout.svelte-df7a6bb0.js"),
        [
          "/_app/pages/$layout.svelte-df7a6bb0.js",
          "/_app/assets/pages/$layout.svelte-364654f7.css",
          "/_app/chunks/vendor-072d9e00.js"
        ]
      ),
    () => G(() => import("./error.svelte-8c2e8ead.js"), void 0),
    () =>
      G(
        () => import("./pages/index.svelte-01fb2e06.js"),
        ["/_app/pages/index.svelte-01fb2e06.js", "/_app/assets/pages/index.svelte-07f59c0f.css"]
      )
  ],
  X = [[/^\/$/, [J[0], J[2]], [J[1]]]],
  F = [J[0](), J[1]()];
  ...
  init(t) {
    ...
    (this.renderer = t),
      ...
      addEventListener("scroll", () => {
        clearTimeout(e),
          (e = setTimeout(() => {
            const t = a(a({}, history.state || {}), { "sveltekit:scroll": H() });
      ...
      addEventListener("click", (t) => {
        ...
        if (a) {
          ...
          history.pushState({}, "", o.href),
            this._navigate(a, r ? H() : null, [], o.hash),
            t.preventDefault();
        }
      }),
    ...
    if (this.enabled) {
      ...
      if (a)
        return (
          ...
          this._navigate(a, e ? H() : null, s, o.hash)
        );
    }
...
class rt {
  constructor({ Root: t, fallback: e, target: r, session: s, host: o }) {
    (this.Root = t),
      ...
      (this.stores = { page: tt({}), navigating: A(null), session: A(s) }),
      (this.$session = null),
      (this.root = null);
    let a = !1;
      ...
      for (let n = 0; n < r.length; n += 1) {
        ...
        if ((o.push(h), h && h.loaded))
          if (h.loaded.error) {
            ...
            (i = h.loaded.status), (l = h.loaded.error);
          } else h.loaded.context && (c = a(a({}, c), h.loaded.context));
      }
  ...
  async _load({ route: t, path: e, query: r }) {
    ...
    const [o, n, i, l] = t,
      ...
      h = { host: this.host, path: e, query: r, params: c },
      d = [];
    let p = {},
      f = !1,
      g = 200,
      m = null;
    n.forEach((t) => t());
    t: for (let _ = 0; _ < n.length; _ += 1) {
      let t;
      try {
        if (!n[_]) continue;
        const e = await n[_](),
          r = this.current.branch[_];
        if (
          !r ||
          e !== r.module ||
          (u.path && r.uses.path) ||
          ...
          t = await this._load_node({ module: e, page: h, context: p });
          const r = _ === n.length - 1;
          if (t && t.loaded) {
            if (
              (t.loaded.error && ((g = t.loaded.status), (m = t.loaded.error)), t.loaded.redirect)
            )
      ...
      if (m) {
        ...
        return await this._load_error({ status: g, error: m, path: e, query: r });
      }
      t && t.loaded && t.loaded.context && (p = a(a({}, p), t.loaded.context)), d.push(t);
    }
    return await this._get_navigation_result_from_branch({ page: h, branch: d });
  }
...
async function st({ paths: t, target: e, session: r, host: s, route: o, spa: a, hydrate: n }) {
  const i = o && new Z({ base: t.base, routes: X }),
    l = new rt({ Root: z, fallback: F, target: e, session: r, host: s });
  n && (await l.start(n)),
    o && i.init(l),
