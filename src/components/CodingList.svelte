...
<main>
  ...
  <section
    id="code"
    class="flex items-center justify-center py-6 bg-divpurple border-4 border-indigo-900 border-dashed min-w-screen"
  >
    <div class="max-w-6xl px-12 mx-auto  md:px-6 xl:px-6">
      <div class="flex flex-col items-center lg:flex-row">
        <div
          class="flex flex-col items-start justify-center w-full h-full px-8 mb-10 lg:mb-0 lg:w-1/2"
        >
          <h2
            id="head-text"
            class="text-4xl font-extrabold leading-10 tracking-tight text-white font-mono lg:w-2/3 sm:text-5xl sm:leading-none md:text-6xl lg:text-5xl xl:text-6xl"
          >
            Code & Dev.
          </h2>
          <p class="my-6 text-lg text-white">
            Programming and development insanities that escaped the lab.
          </p>
          <a
            href="#_"
            class="flex items-center justify-center px-8 py-2 text-base font-medium leading-6 text-white transition duration-150 ease-in-out bg-divorange border border-transparent rounded-md shadow hover:bg-indigo-500 focus:outline-none focus:border-indigo-700 hover:text-white focus:shadow-outline-indigo  md:text-lg md:px-10"
            >View All</a
          >
        </div>
