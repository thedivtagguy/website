...
<!-- Section 1 -->
<section id="code" class="flex items-center justify-center py-6 bg-divpurple border-4 border-indigo-900 border-dashed min-w-screen">
    <div class="max-w-6xl px-12 mx-auto  md:px-6 xl:px-6">
        <div class="flex flex-col items-center lg:flex-row">
            <div  class="flex flex-col items-start justify-center w-full h-full px-8 mb-10 lg:mb-0 lg:w-1/2">
                <h2 id="head-text" class="text-4xl font-extrabold leading-10 tracking-tight text-white font-mono lg:w-2/3 sm:text-5xl sm:leading-none md:text-6xl lg:text-5xl xl:text-6xl">Code & Dev.</h2>
                <p class="my-6 text-lg text-white">Programming and development insanities that escaped the lab.</p>
            ...
            <div class="w-full flex-col flex gap-4 lg:w-1/2">
                ...
                <div class="flex group items-center justify-between w-full col-span-1 p-2 bg-white hover:cursor-pointer hover:bg-divorange rounded-lg shadow">
                    <div class="px-4 py-1 flex flex-col">
                        <div class="relative ">
                            <p class=" text-sm text-gray-600 group-hover:text-white font-sans uppercase font-bold sm:text-lg lg:text-lg xl:text-lg">{development.heading}</p>
                        </div>
